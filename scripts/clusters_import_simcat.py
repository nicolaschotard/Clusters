...
for i in np.arange(8):
    ...
    catfile = '/Users/combet/RECHERCHE/LSST/RTF/analysis/SIM/cat0'+str(i)+'_sim.hdf5'  # to be used with "clusters_mass.py config.yaml cat_wtg.hdf5"
